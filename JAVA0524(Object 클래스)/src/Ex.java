...
public class Ex {
	...
	public static void main(String[] args) {
		...
		if(p1.equals(p2)) { // 동등비교 연산 (==)과 동일한 결과를 수행
			System.out.println("두 객체의 주소 값이 같다! (equals())");
		}else {
			System.out.println("두 객체의 주소 값이 다르다! (equals())");
		}
		...
		if(p10.equals(p11)) {
			System.out.println(" 두 객체의 내용(멤버 변수 값)이 같다!");
		}else {
			System.out.println("두 객체의 내용(멤버 변수 값)이 다르다!");
		}
...
class OverridePerson{
	...
	//Object 클래스의 equals() 메서드 오버라이딩
		...
		// 하나라도 다를 경우 false를 리턴, 모두 같을 경우 true 리턴하도록 수정(재정의)
//	
//	@Override
//	public boolean equals(Object obj) {
//		
