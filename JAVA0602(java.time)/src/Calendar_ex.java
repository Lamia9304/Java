...
//		Calendar cal=new Calendar(); // 인스턴스 생성 불가
		...
		Calendar cal= Calendar.getInstance(); // 현재 시스템 나라 및 시각 정보를 리턴
...
//		System.out.println(cal);
		...
		cal2.set(1999,11,31); //연, 일, 월, 직접 전달
		...
		cal2.set(Calendar.YEAR, 2010); //2010년으로 설
