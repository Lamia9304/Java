...
public class map {
	...
	public static void main(String[] args) {
		/*
		 * 3. Map 계열 - 키(key)와 값(value)을 한 쌍으로 갖는 자료구조 => 키와 값을 한 쌍으로 갖는 Map.Entry 타입
		 * 객체로 관리됨 - 키는 중복 불가, 값은 중복 가능 => 키는 Set 타입으로 관리됨 - 대표적인 구현체 클래스 : HsahMap,
		 * Properties 등 - toString() 메서드가 오버라이딩 되어 있음 - 전화번호부, 가격표 등의 한 쌍의 데이터를 매핑하는 구조에
		 * 활용
		 */
